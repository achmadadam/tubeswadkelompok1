...
<div class="account-popup-area signup-popup-box">
    <div class="account-popup">
        <span class="close-popup"><i class="la la-close"></i></span>
        <h3>Sign Up</h3>
        <form method="post" action="php/daftar.php" enctype="multipart/form-data">
            <div class="cfield">
            ...
            <div class="cfield">
                <input type="number" placeholder="Nomor Telepon" name="notelp" />
                <i class="la la-phone"></i>
            </div>
            <div class="dropdown-field">
                <select data-placeholder="Jenis Kelamin" class="chosen" name="jk">
